...
public class Loan {
	...
	public double GetPMT() {
		...
		PMT = Math.abs(FinanceLib.pmt(this.InterestRate/12,this.LoanPaymentCnt, this.LoanAmount, 0, false));
		return PMT;
	}
	...
	public double getTotalInterest() {
		...
		double interest = 0;
		for(Payment pay:loanPayments) {
			interest += pay.getInterestPayment();
		}
		return interest;
	}
